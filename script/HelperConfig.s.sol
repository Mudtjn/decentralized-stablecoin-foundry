...
contract CodeConstants {
    ...
    uint256 public constant ETH_ANVIL_CHAIN_ID = 31_337;
...
contract HelperConfig is Script, CodeConstants {
    ...
    function getAnvilEthConfig() public returns (NetworkConfig memory localNetworkConfig) {
